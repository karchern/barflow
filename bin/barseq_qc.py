...
parser.add_argument('--min_mean_barcode_count', type=float, help="Minimum mean barcode count for sample to pass QC.")
...
rows.append({
    ...
    'qc_min_mean_barcode_count_threshold': min_mean_threshold,
