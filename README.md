...
```
Sample_treatment_1,some/path/to/test_data/good_barcodes_with_locustag.csv
Sample_treatment_2,some/path/to/test_data/good_barcodes_with_locustag.csv
Sample_control_1,some/path/to/test_data/good_barcodes_with_locustag.csv
Sample_control_2,some/path/to/test_data/good_barcodes_with_locustag.csv
```
